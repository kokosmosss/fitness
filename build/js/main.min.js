...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_swiper__WEBPACK_IMPORTED_MODULE_3__["initTrainersSwiper"])();
    Object(_modules_init_swiper__WEBPACK_IMPORTED_MODULE_3__["initReviewsSwiper"])();
  });
});
...
/*!***********************************!*\
  !*** ./js/modules/init-swiper.js ***!
  \***********************************/
/*! exports provided: initTrainersSwiper, initReviewsSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initTrainersSwiper", function() { return initTrainersSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initReviewsSwiper", function() { return initReviewsSwiper; });
...
var tabs = function tabs() {
  var head = document.querySelector('.catalog__tabs');
  var body = document.querySelector('.catalog__tab-content');
  ...
  var setActiveContent = function setActiveContent() {
    ...
    body.querySelector("[data-tab=\"".concat(getActiveTabName(), "\"]")).classList.add('catalog__list--active');
  };
  if (!body.querySelector('.catalog__list--active')) {
  ...
  head.addEventListener('click', function (event) {
    var caption = event.target.closest('.catalog__tab');
    if (!caption) {
      return;
    }
...
var videoBlock = document.querySelector('.gym__video');
var button = videoBlock.querySelector('.gym__video-button');
